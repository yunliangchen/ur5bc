...
def get_config(config_string):
    possible_structures = {
        "franka_bc": ml_collections.ConfigDict(
            dict(
                agent="bc",
                batch_size=256,
                num_steps=int(2e6),
                ...
                eval_interval=100,
                save_interval=100,
                save_dir="gs://rail-tpus-homer/log",
                data_path="/nfs/kun2/users/homer/datasets/franka/tfrecord",
                resume_path=None,
                seed=42,
                agent_kwargs=dict(
                    network_kwargs=dict(
        ...
        "gc_iql": ml_collections.ConfigDict(
            dict(
                ...
                save_interval=5000,
                save_dir="gs://rail-tpus-homer/log",
                data_path="gs://rail-tpus-homer/data_new",
                resume_path=None,
                seed=42,
                agent_kwargs=dict(
                    network_kwargs=dict(
        ...
        "sim_gc_bc": ml_collections.ConfigDict(
            dict(
                ...
                data_path="/mnt2/homer/datasets/mujoco_sim/franka_shoe_pick_and_place_1000_20230508-115404",
                resume_path=None,
                seed=42,
        ...
        "gc_ddpm_bc": ml_collections.ConfigDict(
            dict(
                agent="gc_ddpm_bc",
                batch_size=256,
                num_steps=int(2e6),
