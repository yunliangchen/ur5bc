...
CMD="python experiments/homer/bridgedata_offline_gc.py \
    --config experiments/homer/configs/offline_pixels_config.py:gc_ddpm_bc \
    --bridgedata_config experiments/homer/configs/bridgedata_config.py:all \
    --name $NAME"
