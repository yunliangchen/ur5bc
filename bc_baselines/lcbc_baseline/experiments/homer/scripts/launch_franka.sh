...
CMD="python experiments/homer/bridgedata_offline.py \
    --config experiments/homer/configs/offline_pixels_config.py:franka_bc \
    --bridgedata_config experiments/homer/configs/bridgedata_config.py:franka \
    --name $NAME"
